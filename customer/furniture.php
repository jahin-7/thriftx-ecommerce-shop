...
if ($sort_by == 'lowToHigh') {
    $query = "SELECT * FROM products WHERE category = 'furniture' ORDER BY price ASC";
} else if ($sort_by == 'highToLow') {
    $query = "SELECT * FROM products WHERE category = 'furniture' ORDER BY price DESC";
} else {
    $query = "SELECT * FROM products WHERE category = 'furniture'"; // Default query if no sort is selected
}

$furniture_result = $conn->query($query);
?>
...
<body>
    ...
    <section class="sort-filter">
        ...
        <select id="sortBy" onchange="window.location.href='furniture.php?sort_by=' + this.value">
    ...
    <section class="products">
        ...
        <div class="product-list">
            <?php while ($product = $furniture_result->fetch_assoc()): ?>
