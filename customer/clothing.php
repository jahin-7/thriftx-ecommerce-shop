...
if ($sort_by == 'lowToHigh') {
    $query = "SELECT * FROM products WHERE category = 'clothing' ORDER BY price ASC";
} else if ($sort_by == 'highToLow') {
    $query = "SELECT * FROM products WHERE category = 'clothing' ORDER BY price DESC";
} else {
    $query = "SELECT * FROM products WHERE category = 'clothing'"; // Default query if no sort is selected
}

$clothing_result = $conn->query($query);
?>
...
<body>
    ...
    <div class="page-header">
        <div class="page-title">
            <h1>Clothing</h1>
            <p>Find stylish and affordable clothing items</p>
        </div>
    ...
    <section class="sort-filter">
        ...
        <select id="sortBy" onchange="window.location.href='clothing.php?sort_by=' + this.value">
    ...
    <section class="products">
        ...
        <div class="product-list">
            <?php while ($product = $clothing_result->fetch_assoc()): ?>
